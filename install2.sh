...
sudo gfortran TEST_1_fortran_only_fixed.f
./a.out
...
sudo gfortran TEST_2_fortran_only_free.f90
./a.out
...
sudo gcc -c -m64 TEST_4_fortran+c_c.c
sudo gfortran -c -m64 TEST_4_fortran+c_f.f90
sudo gfortran -m64 TEST_4_fortran+c_f.o TEST_4_fortran+c_c.o
./a.out
